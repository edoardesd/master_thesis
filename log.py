...
def signal_handler():
	...
	subprocess.Popen(['mysqlimport', '--ignore-lines=1', '--fields-terminated-by=,', '--columns=\'mac_address,timestamp,rasp,echo_time,rssi\'', '--local', '-u', +db_user+ '-h' +db_host+ ' -p'+db_pass+ ' ' +db_database+' '+pwd+starting_day+'/'+starting_time+'/'+db_table+'_bluetooth.csv'])
